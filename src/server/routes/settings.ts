...
export function settingsRouter(db: Database): Router {
  ...
  router.patch('/', asyncRoute(async (req, res) => {
    ...
    const input: UpdateSettingsInput = {
      interface_language: optionalString('interface_language', body.interface_language),
      default_target_language: optionalString('default_target_language', body.default_target_language),
      default_definition_language: optionalString('default_definition_language', body.default_definition_language),
    };
