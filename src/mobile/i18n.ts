...
export interface MobileStrings {
  ...
  progress: string; pending: string; lanAddress: string; apply: string; scanProfile: string; wrongAgain: string;
  next: string; confirmAgain: string; syncHelp: string; favorite: string; unfavorite: string; markMastered: string;
}
...
const en: MobileStrings = {
  ...
  save: 'Save', language: 'Language', videoUnavailable: 'Video has not been downloaded yet. Sync again when connected.',
  progress: 'Today', pending: 'Pending upload', lanAddress: 'LAN HTTPS address', apply: 'Apply', scanProfile: 'Scan connection QR',
  wrongAgain: 'Wrong — Again', next: 'Next', confirmAgain: 'Confirm Again',
  favorite: 'Favorite', unfavorite: 'Remove favorite', markMastered: 'Mark mastered',
  syncHelp: 'Uploads offline reviews, refreshes the canonical PC snapshot, and downloads missing offline media.',
};

export const mobileTranslations: Record<SupportedLanguage, MobileStrings> = {
  英语: en,
  中文: { ...en, offline: '离线复习', pairTitle: '与电脑配对', pairHelp: '扫描电脑设置页中的二维码，或粘贴配对文本。', scan: '扫描二维码', pair: '配对设备', waiting: '等待电脑确认…', lan: '局域网', tailscale: 'Tailscale', sync: '立即同步', syncing: '正在同步…', lastSync: '上次同步', unpair: '解除配对', noDue: '当前没有到期卡片。', again: '重来', good: '记住了', connection: '连接方式', error: '错误', preparing: '正在准备加密离线存储…', updateConnection: '更新连接资料', save: '保存', language: '界面语言', videoUnavailable: '视频尚未下载，请在连接电脑后再次同步。', wrongAgain: '答错了，改为重来', next: '下一张', confirmAgain: '确认重来', favorite: '收藏', unfavorite: '取消收藏', markMastered: '标记熟记', syncHelp: '上传离线复习记录和卡片操作、刷新电脑生成的规范快照，并下载缺少的离线媒体。' },
