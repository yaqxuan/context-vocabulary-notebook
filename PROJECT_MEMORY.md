...
The user wants selected pages to show a small bilingual line that can be motivational, poetic, or playful. The learning language should be visually primary and the familiar language smaller. Homepage greeting labels for time segments should use only the familiar UI language (Chinese in the current example), while the greeting phrase itself can be bilingual. Homepage greetings should refresh at the local day boundary at 00:00 and distinguish weekday vs weekend plus time bands only: 04:00-07:00, 07:00-11:00, 11:00-13:00, 13:00-18:00, 18:00-21:00, 21:00-23:00, and shared 23:00-04:00. Do not include holiday logic. The user supplied 10 Chinese greeting candidates per weekday/weekend time band and wants random selection; avoid immediate repeats by remembering the last selected phrase when practical. AI-generated variants are a future scope expansion/API decision; for V1, prefer a curated local phrase bank or deterministic copy unless the user explicitly approves adding AI runtime behavior. Statistics page should show the recent 14-day review quantity chart and an additional historical monthly quantity view grouped by month.
