...
أداة مراجعة مفردات سياقية خفيفة الوزن تعطي الأولوية للتخزين المحلي. مناسبة لتسجيل الكلمات الجديدة والجمل الأصلية ومقاطع الفيديو المحلية ولقطات الشاشة والصوت والعلامات أثناء مشاهدة مقاطع الفيديو باللغات الأجنبية، ثم جدولة المراجعات باستخدام خوارزمية FSRS.
...
- يمكن ربط إدخال معنى واحد بمثيلات سياق متعددة، مما يجعله مثاليًا لتسجيل استخدامات نفس المعنى في مقاطع فيديو مختلفة.
- مرفقات الوسائط المحلية: فيديو `mp4`، صوت `mp3`، صورة `jpg / png / webp`.
- التكرار المتباعد FSRS: يتم الاحتفاظ بأزرار التقييم `Again` / `Good` فقط.
- قائمة إدخالات المعنى، البحث، التصفية حسب العلامة، المفضلة، الإحصائيات.
- استيراد وتصدير ZIP: يدعم النسخ الاحتياطي الشخصي الكامل ومشاركة البطاقات فقط.
